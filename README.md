# zi2zi-chain: Master Chinese Calligraphy with CGAN: Generating calligraphy font images and creating calligraphy fonts.
...
方正多宝塔碑推理效果如下：
![新楷体——楷书-方正多宝塔碑](results/楷-方正多宝塔碑.jpg)
...
if you want to infer on some your txt and **DON'T want to generate pickle object file**,  use the command below:
